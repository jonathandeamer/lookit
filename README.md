...
Homebrew and the Linux packages install the manual for you. From an archive, unpack into a fresh directory, then put both files where they belong. Replace the example archive name with the file you downloaded:
