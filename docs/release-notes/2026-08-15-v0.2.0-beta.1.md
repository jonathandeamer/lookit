...
- @MsfPablo kept a service row readable when its own token is a bare numeral, which had been indistinguishable from a list number under the tree connector ([#104](https://github.com/jonathandeamer/lookit/pull/104)).
