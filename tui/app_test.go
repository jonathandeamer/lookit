...
func TestBackgroundColorMsgRestylesTUI(t *testing.T) {
	...
	assertRuleOnlyShelf(t, "inactive start selection before restyle", m.start.View(), "@cosmic.voyage", 1, m.common.styles.palette.Rule, m.common.styles.palette.SubtleBg)
	...
	assertRuleOnlyShelf(t, "inactive start selection after restyle", got.start.View(), "@cosmic.voyage", 1, got.common.styles.palette.Rule, got.common.styles.palette.SubtleBg)
}
