...
func TestBackgroundColorMsgRestylesTUI(t *testing.T) {
	...
	assertRuleOnlyShelfLine(t, "inactive start selection before restyle", lineContaining(t, m.start.View(), "@cosmic.voyage"), m.common.styles.palette.Rule, m.common.styles.palette.SubtleBg)
	...
	assertRuleOnlyShelfLine(t, "inactive start selection after restyle", lineContaining(t, got.start.View(), "@cosmic.voyage"), got.common.styles.palette.Rule, got.common.styles.palette.SubtleBg)
}
