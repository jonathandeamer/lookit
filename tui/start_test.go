...
func TestStartSelectionShelfFollowsContentFocus(t *testing.T) {
	...
	common.contentFocused = false
	assertRuleOnlyShelf(t, "inactive start selection", m.View(), "@tilde.team", 1, common.styles.palette.Rule, common.styles.palette.SubtleBg)
	...
	common.width = startWideMinWidth - 1
	narrow := newStart(common, twoSections(), "", "")
	assertRuleOnlyShelf(t, "inactive start selection, narrow layout", narrow.View(), "@tilde.team", 2, common.styles.palette.Rule, common.styles.palette.SubtleBg)
}
